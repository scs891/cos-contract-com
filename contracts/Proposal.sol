...
contract Proposal is Base
{
    ...
    function accept(ProposalDetail memory proposal, PaymentDetail[] memory paymentDetails) public payable returns (ProposalDetail memory) {
        ...
        proposal.voteSetup = VoterSetup(voterSetting.voteMSupportPercent, voterSetting.voteMinApprovalPercent, voterSetting.voteMinDurationHours, voterSetting.voteMaxDurationHours);
